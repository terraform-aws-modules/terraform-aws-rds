...
| <a name="input_blue_green_update_enabled"></a> [blue\_green\_update\_enabled](#input\_blue\_green\_update\_enabled) | Enables low-downtime updates using RDS Blue/Green deployments. | `bool` | `false` | no |
