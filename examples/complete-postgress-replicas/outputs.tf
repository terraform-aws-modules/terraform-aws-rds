...
output "this_db_instance_cross-region_replica_arn" {
  description = "The ARN of the RDS replica"
  value       = "${module.db-crossregion-replica.this_db_instance_replica_arn}"
}

output "this_db_instance_replica_arn" {
  description = "The ARN of the RDS replica"
  value       = "${module.db-replica.this_db_instance_replica_arn}"
}
