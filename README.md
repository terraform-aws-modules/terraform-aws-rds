...
[compliance.tf](https://compliance.tf/docs/workarounds/terraform-aws-rds/?utm_source=github&utm_medium=readme&utm_campaign=known-limitations) serves this module with these rules applied at
...
https://registry.compliance.tf/playground?module=terraform-aws-modules/rds/aws&rules=lifecycle_ignore_secret_rotation,lifecycle_prevent_destroy_data - no account needed.
